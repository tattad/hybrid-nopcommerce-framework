...
import static reportConfigs.ExtentManagerV5.getTest;

public class ExtentListenerV5 implements ITestListener {
    ...
    public void onTestSkipped(ITestResult iTestResult) {
        getTest().log(Status.SKIP, MarkupHelper.createLabel(iTestResult.getName() + " - Skipped", ExtentColor.YELLOW));
    }
